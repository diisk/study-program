...
export default function Quiz(){
    const [randomQuestions, setRandomQuestion] = useState([...questions]);
    ...
    return <Questao 
    key={index} text={question.text} options={question.options} exp={question.exp} att={()=>{
...
function Questao(props){
    ...
    return(
        <div className="question">
            ...
            {disabled ? <button onClick={props.att}>Avançar</button> : null}
